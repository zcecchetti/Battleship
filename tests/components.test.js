...
describe('Tests gameboard factory function and methods', () => {
  ...
  test('Creates a new ship and places it horizontally on gameboardArray', () => {
    expect(gameboardArray.placeShip(shipOne, 'h', 3, 4)).toEqual([
      ...
      ['x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x'],
      ['x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x'],
      ['x', 'x', 'x', { object: shipOne, index: 0, direction: 'h' }, { object: shipOne, index: 1, direction: 'h' }, { object: shipOne, index: 2, direction: 'h' }, 'x', 'x', 'x', 'x'],
      ['x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x'],
      ['x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x'],
      ['x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x'],
      ['x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x'],
  ...
  test('Creates a new ship and places it vertically on gameboardArray', () => {
    expect(gameboardArray.placeShip(shipTwo, 'v', 7, 4)).toEqual([
      ...
      ['x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x'],
      ['x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x'],
      ['x', 'x', 'x', { object: shipOne, index: 0, direction: 'h' }, { object: shipOne, index: 1, direction: 'h' }, { object: shipOne, index: 2, direction: 'h' }, 'x', { object: shipTwo, index: 0, direction: 'v' }, 'x', 'x'],
      ['x', 'x', 'x', 'x', 'x', 'x', 'x', { object: shipTwo, index: 1, direction: 'v' }, 'x', 'x'],
      ['x', 'x', 'x', 'x', 'x', 'x', 'x', { object: shipTwo, index: 2, direction: 'v' }, 'x', 'x'],
      ['x', 'x', 'x', 'x', 'x', 'x', 'x', { object: shipTwo, index: 3, direction: 'v' }, 'x', 'x'],
      ['x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x'],
      ['x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x']]);
  });
...
describe('Tests attack methods and interactions between ship objects and gameboard object', () => {
  ...
  test('Checks that receiveAttack method will place a missed point on the gameboard in the correct space', () => {
    expect(gameboardArray.receiveAttack(1, 5)).toEqual([
      ...
      ['x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x'],
      ['x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x'],
      ['x', { object: shipOne, index: 0, direction: 'h' }, { object: shipOne, index: 1, direction: 'h' }, { object: shipOne, index: 2, direction: 'h' }, 'x', 'x', 'x', 'x', 'x', 'x'],
      ['x', 'x', 'x', 'x', 'x', 'x', 'x', { object: shipTwo, index: 0, direction: 'v' }, 'x', 'x'],
      ['x', 'M', 'x', 'x', 'x', 'x', 'x', { object: shipTwo, index: 1, direction: 'v' }, 'x', 'x'],
      ['x', 'x', 'x', 'x', 'x', 'x', 'x', { object: shipTwo, index: 2, direction: 'v' }, 'x', 'x'],
      ['x', 'x', 'x', 'x', 'x', 'x', 'x', { object: shipTwo, index: 3, direction: 'v' }, 'x', 'x'],
      ['x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x'],
      ['x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x']]);
  ...
  test('Checks that receiveAttack method updates gameboard with hit marker in correct space', () => {
    expect(gameboardArray.receiveAttack(1, 3)).toEqual([
      ...
      ['x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x'],
      ['x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x'],
      ['x', { object: shipOne, index: 'H', direction: 'h' }, { object: shipOne, index: 1, direction: 'h' }, { object: shipOne, index: 2, direction: 'h' }, 'x', 'x', 'x', 'x', 'x', 'x'],
      ['x', 'x', 'x', 'x', 'x', 'x', 'x', { object: shipTwo, index: 0, direction: 'v' }, 'x', 'x'],
      ['x', 'M', 'x', 'x', 'x', 'x', 'x', { object: shipTwo, index: 1, direction: 'v' }, 'x', 'x'],
      ['x', 'x', 'x', 'x', 'x', 'x', 'x', { object: shipTwo, index: 2, direction: 'v' }, 'x', 'x'],
      ['x', 'x', 'x', 'x', 'x', 'x', 'x', { object: shipTwo, index: 3, direction: 'v' }, 'x', 'x'],
  ...
  test('Checks that gameboardArray will update hit markers with sunk markers if isSunk is true', () => {
    expect(gameboardArray.returnBoard()).toEqual([
      ...
      ['x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x'],
      ['x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x'],
      ['x', { object: shipOne, index: 'S', direction: 'h' }, { object: shipOne, index: 'S', direction: 'h' }, { object: shipOne, index: 'S', direction: 'h' }, 'x', 'x', 'x', 'x', 'x', 'x'],
      ['x', 'x', 'x', 'x', 'x', 'x', 'x', { object: shipTwo, index: 0, direction: 'v' }, 'x', 'x'],
      ['x', 'M', 'x', 'x', 'x', 'x', 'x', { object: shipTwo, index: 1, direction: 'v' }, 'x', 'x'],
      ['x', 'x', 'x', 'x', 'x', 'x', 'x', { object: shipTwo, index: 2, direction: 'v' }, 'x', 'x'],
      ['x', 'x', 'x', 'x', 'x', 'x', 'x', { object: shipTwo, index: 3, direction: 'v' }, 'x', 'x'],
